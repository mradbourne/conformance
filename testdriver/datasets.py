...
class DataSet:
    def __init__(
        self, test_type, testDataFilename, verifyFilename, versionCLDR, versionICU
    ):
...
icu_version_names = [i.value for i in ICUVersionName]
...
testDatasets[testName] = DataSet(
    testType.collation_short.value,
    "collation_test.json",
...
allExecutors.addSystem(
    ...
    "node ../executors/node/executor.js",
    CLDRVersion.CLDR41,
    versionICU=ICUVersion.ICU71,
)

allExecutors.addSystem(
    system,
    NodeVersion.Node18_7,
    "node ../executors/node/executor.js",
    CLDRVersion.CLDR42,
    versionICU=ICUVersion.ICU72,
)
...
allExecutors.addSystem(
    ...
    "node ../executors/node/executor.js",
    CLDRVersion.CLDR40,
    versionICU=ICUVersion.ICU70,
)

allExecutors.addSystem(
    system,
    NodeVersion.Node14_18,
    "node ../executors/node/executor.js",
    CLDRVersion.CLDR39,
    versionICU=ICUVersion.ICU69,
)

allExecutors.addSystem(
    system,
    NodeVersion.Node14_17,
    "node ../executors/node/executor.js",
    CLDRVersion.CLDR38,
    versionICU=ICUVersion.ICU68,
)
...
def main(args):
    ...
    for lang in [ExecutorLang.NODE, ExecutorLang.RUST, ExecutorLang.CPP, "newLanguage"]:
